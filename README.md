...
> [!NOTE]
> Репозиторий полностью открыт: можете использовать любые конфиги и гайды для своих систем.
...
### [Gentoo Linux]
Система которую я при первой установке проклинал, и молился всем богам чтобы они помогли мне, но все же я её люблю за полный контроль.
* (p.s. все же долгие компиляции нашей коровки до сих пор выбешивают)

### [Void Linux]
Очень похож на арч, но намного шустрее его, имеет свой пакетник XBPS, не использует СОЙстемд

### [Artix Linux]
Тот же арч но без systemd

---

## В планах:
- [ ] гайд по настройке великого хупрленда (Hyprland).
- [ ] добавить раздел с никсом (NixOS).
